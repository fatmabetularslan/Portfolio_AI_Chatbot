    ...
    def execute_tool(self, tool_name: str, tool_args: Dict) -> Dict[str, Any]:
        if tool_name == "prepare_email":
            ...
            try:
                ...
                st.session_state.pdf_filename = f"job_compatibility_{datetime.now().strftime('%Y%m%d_%H%M%S')}.pdf"
                return {"success": True, "message": "PDF ready.", "data": {"filename": st.session_state.pdf_filename}}
            except Exception as e:
            ...
            try:
                ...
                st.session_state.last_report_language = language
                return {"success": True, "message": "Analysis done", "data": report_data}
            except Exception as e:
            ...
            try:
                ...
                return {"success": True, "message": "Cover letter created", "data": result}
            except Exception as e:
